	...
	<div style="position: relative; left: 10px; top: -20px; z-index: 1;">
		<section class="products" id="products">
			<div class="box-container">
				...
				<table border="1" width="1000px" height="500px" class="line" >
					<thead>
						<tr >
							<td class="line" >상품번호</td>
							<td class="line" >수량</td>
							<td class="line" >가격</td>
						</tr>
					</thead>
					<tbody  >
						<c:forEach var="row" items="${data1}">
							<tr>
								<td class="line">${row.pd_num}</td>
								<td class="line" >${row.orderCount}</td>
								<td class="line">${row.price}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
